...
learning_rate = 0.001
epochs = 30
steps = 2  # steps per epoch
num_classes = 6
eval_ratio = 0.3
batch_size = 4 # actual batch size = num GPU * batch_size
...
model = MaskRCNN(mode='training', model_dir=os.path.abspath(saving_path), config=config)
